...
class ModelCustomerCustomField extends Model {
	public function addCustomField(array $data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "custom_field` SET type = '" . $this->db->escape($data['type']) . "', value = '" . $this->db->escape($data['value']) . "', validation = '" . $this->db->escape($data['validation']) . "', location = '" . $this->db->escape($data['location']) . "', status = '" . (bool)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editCustomField(int $custom_field_id, array $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "custom_field` SET type = '" . $this->db->escape($data['type']) . "', value = '" . $this->db->escape($data['value']) . "', validation = '" . $this->db->escape($data['validation']) . "', location = '" . $this->db->escape($data['location']) . "', status = '" . (bool)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomFieldDescriptions(int $custom_field_id) {
		$custom_field_data = [];
	...
	public function getCustomFieldValue(int $custom_field_value_id) {
	...
	public function getCustomFieldValues(int $custom_field_id) {
	...
	public function getCustomFieldCustomerGroups(int $custom_field_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field_customer_group` WHERE custom_field_id = '" . (int)$custom_field_id . "'");

		return $query->rows;
	}

	public function getCustomFieldValueDescriptions(int $custom_field_id) {
		$custom_field_value_data = [];
