<table class="transactions list">
    <thead>
        <tr>
            ...
            <td class="text-left"><?php echo $column_transaction_reference; ?></td>
            <td class="text-left"><?php echo $column_customer; ?></td>
            <td class="text-left"><?php echo $column_total; ?></td>
            <td class="text-left"><?php echo $column_currency; ?></td>
            <td class="text-left"><?php echo $column_settle_status; ?></td>
    ...
    <tbody>
        <?php if ($transactions) { ?>
            ...
            <tr>
                <td class="text-left"><a href="<?php echo $transaction['order_href']; ?>" target="_blank"><?php echo $transaction['order_id']; ?></a></td>
                ...
                <td class="text-left"><?php echo $transaction['currency']; ?></td>
                <td class="text-left"><?php echo $transaction['settle_status']; ?></td>
