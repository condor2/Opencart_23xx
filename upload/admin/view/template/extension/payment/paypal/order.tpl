	...
	<div class="col-lg-6">
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td><?php echo $text_transaction_comment; ?></td>
					<td>
						<textarea name="transaction_comment" id="input_transaction_comment" class="form-control"></textarea>
						<div class="checkbox">
							<label><input type="checkbox" name="transaction_notify" value="1" id="input_transaction_notify">&nbsp;<?php echo $text_transaction_notify; ?></label>
						</div>
					</td>
				</tr>
				<tr>
	...
	<div class="col-lg-6">
		<table class="table table-bordered">
			...
			<tbody>
				...
				<?php if (!$tracking_number) { ?>
				<tr>
					<td><?php echo $text_tracker_comment; ?></td>
					<td>
						<textarea name="tracker_comment" id="input_tracker_comment" class="form-control"></textarea>
						<div class="checkbox">
							<label><input type="checkbox" name="tracker_notify" value="1" id="input_tracker_notify">&nbsp;<?php echo $text_tracker_notify; ?></label>
						</div>
					</td>
				</tr>
				<?php } ?>
...
function updateTabPayPal() {
	...
	$('#history').load('<?php echo $info_order_history_url; ?>');
}
