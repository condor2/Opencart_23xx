      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-currency" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="fixer_api" value="<?php echo $fixer_api; ?>" placeholder="<?php echo $entry_api; ?>" id="input-api" class="form-control" />
              <?php if ($error_api) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="fixer_ip" value="<?php echo $fixer_ip; ?>" placeholder="<?php echo $entry_ip; ?>" id="input-ip" class="form-control" />
              <?php if ($error_ip) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="fixer_cron" value="<?php echo $fixer_cron; ?>" placeholder="<?php echo $entry_cron; ?>" id="input-cron" class="form-control" readonly="readonly" />
            </div>
          </div>
        </form>
      </div>
