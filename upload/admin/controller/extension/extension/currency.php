...
class ControllerExtensionExtensionCurrency extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			$this->model_extension_extension->install('currency', $this->request->get['extension']);
	...
	public function uninstall() {
		...
		if ($this->validate()) {
			$this->model_extension_extension->uninstall('currency', $this->request->get['extension']);
	...
	protected function getList() {
		...
		foreach ($extensions as $key => $value) {
			if (!is_file(DIR_APPLICATION . 'controller/extension/currency/' . $value . '.php') && !is_file(DIR_APPLICATION . 'controller/currency/' . $value . '.php')) {
				$this->model_extension_extension->uninstall('currency', $value);
