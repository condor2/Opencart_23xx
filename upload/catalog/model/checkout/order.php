...
class ModelCheckoutOrder extends Model {
	...
	public function editOrder(int $order_id, array $data) {
	...
	public function addOrderHistory(int $order_id, int $order_status_id, string $comment = '', bool $notify = false, bool $override = false) {
