...
class ModelAccountRecurring extends Model {
	...
	public function addOrderRecurringTransaction(int $order_recurring_id, string $type): void {
	...
	public function editOrderRecurringStatus(int $order_recurring_id, bool $status): void {
