...
class ModelAccountOrder extends Model {
	...
	public function getOrderProduct(int $order_id, int $order_product_id) {
	...
	public function getOrderOptions(int $order_id, int $order_product_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_option` WHERE `order_id` = '" . (int)$order_id . "' AND `order_product_id` = '" . (int)$order_product_id . "'");

		return $query->rows;
	}

	public function getOrderVouchers(int $order_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_voucher` WHERE `order_id` = '" . (int)$order_id . "'");

		return $query->rows;
	}

	public function getOrderTotals(int $order_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_total WHERE `order_id` = '" . (int)$order_id . "' ORDER BY `sort_order`");

		return $query->rows;
	}

	public function getOrderHistories(int $order_id) {
	...
	public function getTotalOrderProductsByOrderId(int $order_id) {
	...
	public function getTotalOrderVouchersByOrderId(int $order_id) {
